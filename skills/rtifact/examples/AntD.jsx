    ...
    <main className="min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      <article className="mx-auto max-w-7xl space-y-5">
        ...
        <Alert
          ...
          type="info"
          title="How to review"
          description="Change the rtifact theme, scan every section, and interact with hover, focus, selected, disabled, popup, and portal states. Infrastructure-only exports are documented at the end."
        />
        ...
        >
          ...
          <Demo title="Image · QRCode">
            <Space wrap size="large">
              <Image src={icon} width={96} alt="rtifact icon" preview={false} />
              <QRCode value="https://github.com/sirawats/rtifact" />
            </Space>
          </Demo>
        ...
        <Section id="feedback" title="Feedback" components={CATALOG.Feedback}>
          ...
          <Demo title="Watermark" wide>
            <Watermark content="rtifact theme review">
